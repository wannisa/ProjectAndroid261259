...
//        String a = date+t+timer;
        String startdate = date+t+timer;
        DateTime startDateTime = new DateTime(startdate+":00+07:00");
        ...
        String startdatetimeend = datetimeend+t+timer;

        DateTime endDateTime = new DateTime(startdatetimeend+":00+07:00");
